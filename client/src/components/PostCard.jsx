...
export default function PostCard({ post }) {
    return (
        <div className='dark:bg-black dark:bg-opacity-20 group relative w-full border border-sky-700 hover:border-2 h-[370px] overflow-hidden sm:w-[430px] transition-all duration-300 drop-shadow-md'>
